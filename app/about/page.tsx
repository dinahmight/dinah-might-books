  ...
  return (
    <main className="grain mx-auto max-w-6xl px-6 py-24">
      <div className="grid grid-cols-1 gap-16 md:grid-cols-[380px_1fr] md:items-start">
        <div className="mx-auto w-full max-w-sm overflow-hidden border border-[#d4af5a]/30">
          <Image
        ...
        <div>
          ...
          <p className="mt-2 font-display text-xl italic text-[#d4af5a]">
            &ldquo;Remember my name &mdash; I&apos;m Dinah-Might!&rdquo;
          </p>

          <p className="mt-8 font-body text-lg leading-relaxed text-[#f4ecd8]/80">
          ...
          <blockquote className="mt-12 font-display text-3xl italic leading-snug text-[#f4ecd8]">
